...
const leftCardRender = (id, flag) => {
  ...
  card.innerHTML = `
    ...
    <button class="delete-btn opacity-[0%] hover:opacity-[100] transition duration-150" onclick="deleteTask('${id}')">
      <!-- SVG icon here -->
      <svg class="w-5 h-5" viewBox="-3.2 -3.2 38.40 38.40" fill="#ffffff" stroke="#ffffff">
        <path d="M268,220 C268,219.448 268.448,219 269,219 C269.552,219 270,219.448 270,220 L270,232 C270,232.553 269.552,233 269,233 C268.448,233 268,232.553 268,232 L268,220 Z M273,220 C273,219.448 273.448,219 274,219 C274.552,219 275,219.448 275,220 L275,232 C275,232.553 274.552,233 274,233 C273.448,233 273,232.553 273,232 L273,220 Z M278,220 C278,219.448 278.448,219 279,219 C279.552,219 280,219.448 280,220 L280,232 C280,232.553 279.552,233 279,233 C278.448,233 278,232.553 278,232 L278,220 Z" />
      </svg>
    </button>
  `;

  // Attach click handler to card (not to delete button)
  card.addEventListener("click", (e) => {
